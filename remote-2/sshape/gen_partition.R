...
sc <- spectral.clustering.vec(xs, 2, dprop.1.vec, nsub=700)

sc.indicator.fn <- function(x) sc$indicator(as.vector(x))
...
save(xs, ws.sc, sc, sc.indicator.fn, sc.constrained.targets, isshape1, isshape2, dfn, rprop.1, dprop.1,
...
save(xs, vc.centers, ws.vc, vc, vc.indicator.fn, vc.constrained.targets, isshape1, isshape2, dfn, rprop.1, dprop.1,
